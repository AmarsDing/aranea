...
func scanEvolutionEvent(s scanner) (domain.EvolutionEvent, error) {
	var (
...
func scanEvolutionProposal(s scanner) (domain.EvolutionProposal, error) {
	var (
...
func scanAgentSkillStat(s scanner) (domain.AgentSkillStat, error) {
	var (
