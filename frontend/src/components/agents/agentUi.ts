...
export const promptModes = [
  ...
  { value: "none" as PromptMode, label: "无", caption: "纯工具调用自动化", tokens: "~1K tokens" }
];
...
export function avatarThumbnailUrl(id: string) {
  return avatarAssetUrl(id, "thumbnail");
}

export function avatarFileUrl(id: string) {
  return avatarAssetUrl(id, "file");
}
